// Vanilla item id -> numeric atlas id, the table the chest UI needs to turn
// "minecraft:diamond_sword" into an icon.
//
// This is a factual mapping of the game's own item registry, not authored work,
// and it is the same table every Bedrock addon that draws an inventory uses. It
// comes from the community ChestFormData module maintained by Herobrine64 and
// LeGend077. Credited in /admin > About > Credits, where it belongs.
//
// Do not hand-edit. When Mojang adds items, take a newer copy of the table.
